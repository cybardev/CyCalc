    ...
    if (awaiting_second_operand || is_calculation_complete) {
      ...
      if (input_number === ".") {
        if (!calculator_display.includes(".")) {
          set_calculator_display(
            calculator_display === "0" ? "0." : calculator_display + input_number
          );
        }
      } else {
        set_calculator_display(
          calculator_display === "0" ? input_number : calculator_display + input_number
        );
      }
    }
  };
      ...
      <div className="calculator">
        ...
        <div className="display">
          <div className="operation">
            {first_operand !== null &&
              `${first_operand} ${
                current_operation ? get_operation_symbol(current_operation) : ""
              }`}
          </div>
          <div className="current-value">{calculator_display}</div>
          {is_calculation_complete && <div className="result">= {calculator_display}</div>}
        </div>
